  ...
  return (
    <>
      ...
      <div className="space-y-4 pb-20">
        ...
        <Button
          variant="outline"
          className="w-full justify-start glass-button border-purple-400/30 hover:text-blue-300 hover:border-blue-300/50 hover:bg-blue-300/10"
              ...
              <div
                ...
                className={`group relative flex items-center justify-between p-3 rounded-lg cursor-pointer transition-all duration-200 glass-option ${
                  thread.id === currentThreadId
                    ...
                    : 'hover:bg-blue-400/10 hover:border-blue-400/30'
                }`}
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-blue-400/20 bg-background/80 backdrop-blur-sm">
